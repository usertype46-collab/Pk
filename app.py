        ...
        <body onclick="closeAllCards()">
            ...
            <div class="factory-map" id="map">
                <svg viewBox="0 0 768 1024" preserveAspectRatio="none">
                    <!--
                    【產線路線圖座標詳細解析】 (精確對齊 14436_2.png 實景比例與黑色實體輸送帶)
                    * M 385 620 : 起點 [上料] (滅火器旁) 往上出發
                    * L 385 320 : 向上直行至轉角
                    * L 125 320 : 向左轉向圓形浸泡槽
                    * L 125 125 : 向上穿過圓形浸泡槽
                    * L 675 125 : 向右橫跨前處理區 (三個大型方形槽)
                    * L 675 230 : 向下直行，抵達主線道，準備進入水切爐
                    * L 485 230 : 向左進入水切爐
                    * L 485 295 : 爐內向下直行轉折
                    * L 675 295 : 向右出水切爐並回到右側主線道
                    * L 675 405 : 向下直行，準備進入烘烤爐
                    * L 485 405 : 向左進入烘烤爐
                    * L 485 480 : 爐內向下直行轉折
                    * L 675 480 : 向右出烘烤爐並回到右側主線道
                    * L 675 705 : 沿右側直線深降向下，進入大型噴房右側
                    * L 165 705 : 完全橫穿噴房內部，由噴房最左側穿出
                    * L 165 890 : 沿廠房最左側直線向下
                    * L 310 890 : 向右抵達終點 [下料] (雙機械手臂) 正中央
                    -->
                    <path id="track" d="
                        M 385 620 
                        L 385 320 
